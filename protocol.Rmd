...
following the sample size is 42,243. Table 1 describes the sample
...
-   Use age as test as the forcing variable instead of month of birth.
    ...
    Figure 5 shows the jump in the probability of being in S4 by age at
    test and also that their appear to be no systematic differences
    across the socio-economic background variables by age.
